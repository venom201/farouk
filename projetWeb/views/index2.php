	...
	<div class="welcome">
		<div class="container"> 
			<div class="col-md-7 welcome-grid-left">
				<h3 class="agileits-title">Votre liste de reservations</h3>
				...
				<div class="w3l-table-info">	
					<table class="table table-bordered">
						...
						<tr>
							...
							<td><?php echo $key['statut'];?></td>
							<?php
							if($key['statut']=='en attente')
							{?>

									<td><a href="modifreservation.php?modif=<?php echo $key['id'];?>">Modifier</a></td>
								<?php
							}
							?>
						</tr>
...
basé à Ariana Jadida. Elle se spécialise dans les plats Originaux Tunisiens, avec des plats maison. Mimosas est une filiale de Yum! Brands, Inc., Ariana Jadida, dans l'avenue des mimosas .</p>
			<div class="services-row-agileinfo">
				<div class="col-sm-4 col-xs-4 services-w3grid">
					<a href="note.php" class="glyphicon glyphicon-heart hi-icon" aria-hidden="true"></a>
					<h5>Evaluer</h5>
					<p></p>
				</div>
				<div class="col-sm-4 col-xs-4 services-w3grid">
