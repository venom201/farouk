...
include 'C:/xampp/htdocs/webBack/core/serveurC.php';


$s=new serveurC();
$liste=$s->afficherServeur();
?>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Acceuil</a><i class="fa fa-angle-right"></i>Tables</li>
            </ol>
					  ...
					  <h2>Liste des serveurs</h2>
						...
						<tbody>
							<?php 
								...
								echo'<td>'.$row['sexe'].'</td>';
								echo'<td>'.$row['tel'].'</td>';
								echo'<td>'.$row['carre'].'</td>';
								?>
								<td><a href='supprimerServeurC.php?id=<?php echo$row['id'];?>'>supprimer</a></td>
								<?php
						  		echo'</tr>';
						  		# code...
							}
