...
$counta = $stha->rowCount();
$sthr= $db->query("SELECT * FROM reservations");
$countr = $sthr->rowCount();
$sths= $db->query("SELECT * FROM serveurs");
$counts = $sths->rowCount();
?>
<!DOCTYPE HTML>
<html>
<head>
<title>MIMOSAS Admin Panel Category Flat Bootstrap Responsive Web Template | Home :: w3layouts</title>
...
<div class="copyrights">
	 <p>© 2016 MIMOSAS. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
</div>	
