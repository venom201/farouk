...
if($_SESSION['m'] && $_SESSION['l'] && $_SESSION['r']=='admin')
{
	...
	$id=$_GET['id'];
$s=new serveurC();
$liste=$s->afficherServeurparid($id);
...
<html>
<head>
<title>MIMOSAS Administration | Modifier un serveur :: w3layouts</title>
...
<h3 id="forms-horizontal" align="center">Modifier ce serveur</h3>
<form class="form-horizontal" method="POST" action="../core/modifierServeurC.php">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="age" name="age" value="<?php echo $age; ?>" min="18" max="35">
    </div>
  </div>
   	<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      <input type="number" class="form-control" id="tel" name="tel" value="<?php echo $tel;?>" min="20000000" max="99999999">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label hor-form">Salaire</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" id="salaire" name="salaire" value="<?php echo $salaire;?>" min="600" max="1500">
    </div>
  </div>
  <div class="form-group">
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li><a href="#"><i class="fa fa-check-square-o nav_icon"></i><span>Reservations</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									  <ul>
										<li><a href="affichagereservation.php">Afficher Reservations</a></li>
									</ul>
									</li>
								  </ul>
								</div>
