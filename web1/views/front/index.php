				...
				<div class="menu">
					...
					<div class="toggle"> 
						<ul class="toggle-menu">
							<li><a href="../../../projetweb/views/index.php" class="active"> Home</a></li>
		...
		<div class="banner-text"> 
			<div class="container"> 
				<div class="banner-w3lstext"> 
					<h2>Bienvenue<span>Mimosas Restaurant</span></h2>
					<p></p>
				</div> 
			</div>
		</div>
					...
					<div class="crud" style="right: 150px">
						...
						<table >
							...
							<tr>
								...
								<td class="crudii">
								<img src="../../images/<?php echo $row['image'];?>" alt="" style="border-radius:70%;width: 40%">
